        ...
        <div className="w-full h-full flex flex-col items-center justify-center">
            ...
            <div className="mx-auto my-auto bg-white rounded-md p-3 flex flex-col">
                <div className="relative">
                    ...
                    <button className="absolute right-0 top-0 rounded p-1 hover:bg-zinc-300">
                ...
                <div className="flex gap-2">
                    ...
                    <div className="flex flex-col w-48">
                        ...
                        />
                        <button className="bg-pink-400 rounded-sm hover:bg-pink-500 text-sm font-bold text-white py-1 mt-2">Create</button>
                    </div>
                </div>
